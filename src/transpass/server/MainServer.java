...
import transpass.util.ConnectionClientInfo;
import transpass.util.MyProtocol;
import transpass.util.StringUtil;
...
public class MainServer {
	...
	// 处理登陆请求，即谁发来login信息，谁就会获得所有客户端的信息
